...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),AbstractDict{Symbol,Any},Array{Function,1},Any})
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline.typerecipe_signature_string),RecipesPipeline.Formatted{Array{Int64,1}}})
