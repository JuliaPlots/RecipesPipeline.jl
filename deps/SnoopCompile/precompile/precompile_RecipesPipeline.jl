...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(filter_data),Vector{Float64},Vector{Int64}})
    Base.precompile(Tuple{typeof(is3d),Type})
    Base.precompile(Tuple{typeof(recipe_pipeline!),Any,Any,Any})
    Base.precompile(Tuple{typeof(setindex!),DefaultsDict,Tuple{Float64, Float64},Symbol})
end
